      ...
      <div className="policy-content">
        ...
        <section className="policy-section">
          ...
          <ul className="policy-list">
            ...
            <li>
              Thanh toán qua thẻ tín dụng, ATM nội địa, ví điện tử, điểm thưởng,
              vé mời.
            </li>
        ...
        <section className="policy-section">
          ...
          <p>
            Chi tiết các phương thức thanh toán được mô tả trong phần tiếp theo.
          </p>
        </section>
        ...
        <section className="policy-section">
          ...
          <p>
            Khách hàng có thể nhận vé tại quầy hoặc quét mã QR trên ứng dụng để
            vào rạp.
          </p>
        </section>
        ...
        <section className="policy-section">
          ...
          <p>
            VTI Cinema áp dụng các biện pháp bảo mật chặt chẽ để chống gian lận.
            Nếu phát hiện hoạt động đáng ngờ, hệ thống có thể chặn giao dịch
            hoặc tài khoản.
          </p>
        </section>
        ...
        <section className="policy-section">
          ...
          <p>
            ...
            <br />
            Địa chỉ: Tầng 3, TTTM VTI, 469 Nguyễn Hữu Thọ, Phường Tân Hưng, Quận
            7, TP.HCM
          </p>
        </section>
      </div>
